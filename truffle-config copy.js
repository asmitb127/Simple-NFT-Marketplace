require('dotenv').config()
 ...
 const mnemonic = "teach manual bleak process awkward garlic load taste since want alpha benefit";
 //  const matic_mnemonic = "draft dose hire bundle help dentist pave deer tail lend dismiss current"
 ...
 module.exports = {
   networks: {
    ...
    matic: {
      provider: () => new HDWalletProvider(mnemonic, `https://rpc-mumbai.maticvigil.com/v1/e310bd27810b2c00cc05b39910f443e946c279da`),
      network_id: 80001,
      confirmations: 2,
      gasPrice: '1000000000',
      timeoutBlocks: 200,
